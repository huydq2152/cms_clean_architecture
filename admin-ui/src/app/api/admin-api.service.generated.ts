...
export class AdminApiPostCategoryApiClient {
     ...
     * @return Success
     */
    getPostCategoryById(id: number): Observable<PostCategoryDtoApiResult> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PostCategoryDtoApiResult>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PostCategoryDtoApiResult>;
        }));
    }

    protected processGetPostCategoryById(response: HttpResponseBase): Observable<PostCategoryDtoApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PostCategoryDtoApiResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    deletePostCategory(id: number): Observable<Int32ApiResult> {
        let url_ = this.baseUrl + "/api/postcategory/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<Int32ApiResult>;
                }
            } else
                return _observableThrow(response_) as any as Observable<Int32ApiResult>;
        }));
    }

    protected processDeletePostCategory(response: HttpResponseBase): Observable<Int32ApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getAllPostCategories(): Observable<PostCategoryDtoIEnumerableApiResult> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PostCategoryDtoIEnumerableApiResult>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PostCategoryDtoIEnumerableApiResult>;
        }));
    }

    protected processGetAllPostCategories(response: HttpResponseBase): Observable<PostCategoryDtoIEnumerableApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PostCategoryDtoIEnumerableApiResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    createPostCategory(body?: CreatePostCategoryDto | undefined): Observable<Int32ApiResult> {
        let url_ = this.baseUrl + "/api/postcategory";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreatePostCategory(response: HttpResponseBase): Observable<Int32ApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    updatePostCategory(body?: UpdatePostCategoryDto | undefined): Observable<Int32ApiResult> {
        let url_ = this.baseUrl + "/api/postcategory";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdatePostCategory(response: HttpResponseBase): Observable<Int32ApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processGetAllPostCategoryPaged(response: HttpResponseBase): Observable<PostCategoryDtoIEnumerableApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiRoleApiClient {
     ...
     * @return Success
     */
    getAllRolesPaged(keyword?: string | null | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<RoleDtoPagedResult> {
...
export class AdminApiUserApiClient {
     ...
     * @return Success
     */
    getAllUsersPaged(keyword?: string | null | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<UserDtoPagedResult> {
...
export class PostCategoryDtoApiResult implements IPostCategoryDtoApiResult {
    messages?: string | undefined;
    succeeded?: boolean;
    ...
    constructor(data?: IPostCategoryDtoApiResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.messages = _data["messages"];
            this.succeeded = _data["succeeded"];
            this.data = _data["data"] ? PostCategoryDto.fromJS(_data["data"]) : <any>undefined;
            this.exception = _data["exception"] ? Exception.fromJS(_data["exception"]) : <any>undefined;
            this.code = _data["code"];
        }
    }

    static fromJS(data: any): PostCategoryDtoApiResult {
        data = typeof data === 'object' ? data : {};
        let result = new PostCategoryDtoApiResult();
        result.init(data);
        return result;
    }
...
export interface IPostCategoryDtoApiResult {
    messages?: string | undefined;
    succeeded?: boolean;
    data?: PostCategoryDto;
    exception?: Exception;
...
export class PostCategoryDtoIEnumerableApiResult implements IPostCategoryDtoIEnumerableApiResult {
    messages?: string | undefined;
    succeeded?: boolean;
    data?: PostCategoryDto[] | undefined;
    exception?: Exception;
    code?: number;

    constructor(data?: IPostCategoryDtoIEnumerableApiResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["data"])) {
                ...
                for (let item of _data["data"])
                    this.data!.push(PostCategoryDto.fromJS(item));
            }
            this.exception = _data["exception"] ? Exception.fromJS(_data["exception"]) : <any>undefined;
            this.code = _data["code"];
        }
    ...
    static fromJS(data: any): PostCategoryDtoIEnumerableApiResult {
        data = typeof data === 'object' ? data : {};
        let result = new PostCategoryDtoIEnumerableApiResult();
        result.init(data);
        return result;
    }
...
export interface IPostCategoryDtoIEnumerableApiResult {
    messages?: string | undefined;
    succeeded?: boolean;
    data?: PostCategoryDto[] | undefined;
    exception?: Exception;
